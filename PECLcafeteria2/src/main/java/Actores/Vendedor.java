...
public class Vendedor implements Runnable {
    ...
    private final SalaDescanso salaDescanso; // sala de descanso

    public Vendedor(String id, Despensa despensa, Mostrador mostrador, PauseController pauseController, SalaDescanso salaDescanso) {
        this.id = id;
